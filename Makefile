...
mousepad: src/mousepad.c src/mouse.c src/config.c src/keyboard.c src/keygtk.c
	gcc -std=gnu99 -Wall -o mousepad src/config.c src/mousepad.c src/mouse.c src/keyboard.c src/keygtk.c -lX11 -lXtst -lrt -Wl,--as-needed,--sort-common `pkg-config gtk+-2.0 --libs --cflags`
#	strip mousepad
